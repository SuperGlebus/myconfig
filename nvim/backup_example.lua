...
return {
  ...
  { "hrsh7th/nvim-cmp", event = "InsertEnter", dependencies = {...} },
  {
    ...
    opts = {
      options = {
        transparency = true, -- <-- правильный ключ
      },
      term_colors = true,
      integrations = {
        treesitter = true,
    ...
    config = function(_, opts)
      ...
      -- Принудительно очищаем фон у Normal и Float
      vim.cmd([[
  ...
  --   "LazyVim/LazyVim",
  --   opts = {
  --     colorscheme = "onedark", -- сообщает LazyVim использовать эту тему
  --   },
  -- },
  {
    "folke/trouble.nvim",
